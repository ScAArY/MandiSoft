...
?>
    ...
    <tr>
        <td class="col50" colspan="2">
            <span>दिनांक :- <?php echo date("d/m/Y",strtotime($sale->sale_date)?strtotime($sale->sale_date):strtotime($sale->datetime)); ?></span><hr/>
            <span>क्रo :-<?php echo $sale->sale_id; ?></span>            
        </td>
        <td class="col50" colspan="2">
            <span>लेजर सँo :- <?php echo $sale ->ledger_number; ?></span>
            <hr />
            <span>नाम :- <?php echo $sale ->acc_name_ll?$sale ->acc_name_ll:$sale ->acc_name; ?></span>
        </td>
    </tr>
    <tr class="heading" align="center">
        <th class="col25">Quantity</th><th class="col25">Rate</th><?php if($sale->rebate){ ?><th class="col20">Rebate</th><?php } ?><th class="<?php echo $sale->rebate?"col30":"col50"; ?>">Total Amount</th>
            </tr>
            <tr align="center">
                <td>
                    <?php
